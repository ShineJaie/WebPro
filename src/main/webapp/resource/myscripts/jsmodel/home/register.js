 ...
 *
 */
define(['jquery', 'bootstrap', 'config', 'jquery.history', 'nprogress', 'sweetalert', 'jquery.validate', 'icheck'],
    function ($, bootstrap, config, History, NProgress, sweetalert, jquery_validate, iCheck) {

        var url_register = "/WebPro/register";
        ...
        var initpage_register = function () {
            ...
            $('#page-content-wrapper-outer').load(config.urlConfig.registerPageUrl, {}, function () {

                config.setBrowserHistory('register', 'initpage_register', null, '用户注册',
                    config.urlConfig.registerPageUrl.split(' ')[0]);
